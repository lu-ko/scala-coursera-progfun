...
class ListsSuite extends FunSuite {
  ...
  test("sum of a few numbers") {
    ...
    assert(sum(List(0)) === 0)
    assert(sum(List(1, 3, 2, 6000)) === 6006)
    assert(sum(List(1000, 3, 2, 500)) === 1505)
    assert(sum(List(-100)) === -100)
    assert(sum(List()) === 0)
  }
  ...
  test("max of a few numbers") {
    ...
    assert(max(List(0)) === 0)
    assert(max(List(1, 3, 2, 6000)) === 6000)
    assert(max(List(1000, 3, 2, 500)) === 1000)
    assert(max(List(-100)) === -100)
